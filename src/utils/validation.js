...
// Mirrors the client policy in src/validation/schemas.js — keep both in sync.
export function validatePassword(password) {
  if (!password || password.length < 10) return 'Min 10 characters';
  ...
  if (!/[^A-Za-z0-9]/.test(password)) return 'Needs 1 special character';
  return null;
}
